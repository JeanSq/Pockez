...
export const translations = {
  en: {
    ...
    // Workout Log (was Notes → transformed)
    logTitle: "Log",
    logHint: "Training log, PRs, and session totals. Saves automatically.",
    logDateLabel: "Date",
    logTotalLifted: "Total lifted",
    logTotalReps: "Total reps",
    logExercisesLabel: "Exercises",
    logExerciseNameLabel: "Exercise",
    logRepsLabel: "Reps",
    logKgsLabel: "Kg",
    logAddExercise: "Add",
    logAddCustomExercise: "Exercise name",
    logRemoveExercise: "Remove exercise",
    logAddSet: "Add set",
    logRemoveSet: "Remove set",
    logCustomPlaceholder: "Exercise name",
    logFeelingsLabel: "How did it feel?",
    logFeelingsPlaceholder: "Notes on effort, mood, recovery…",
    logSave: "Save",
    logSaving: "Saving…",
    logSaved: "Saved",
    logNoSessions: "No training sessions yet. Log your first one!",
    logNewSession: "New session",
    logNewPr: "NEW PR",
    logExercisesTiny: "ex",
    logEmptyFlourish: "Nothing here yet — your first session is one tap away.",
    logSelectHint: "Pick a session to review or edit it",
    celebrationLight: "You lifted {total} kg today!",
    celebrationModerate: "Nice work — {total} kg moved. Keep going!",
    celebrationStrong: "Strong session! {total} kg crushed.",
    celebrationBeast: "🔥 {total} kg! That's a T-Rex's breakfast weight!",
    celebrationDefault: "You moved {total} kg today.",
    celebrationRepCount: "That's {reps} total reps — impressive stamina!",
    celebrationElephant: "That's like lifting an elephant!",
    celebrationElephant2: "An adult elephant weighs about that much!",
    celebrationTyrannosaurus: "A T-Rex would back up slowly.",
    celebrationBlueWhale: "Heavier than a blue whale's heart!",
    celebrationSmallCar: "Heavier than a small car!",
    celebrationGrandPiano: "As heavy as a grand piano!",
    celebrationBabyElephant: "As heavy as a baby elephant!",
    celebrationWashingMachine: "About as heavy as a washing machine!",
    celebrationPanda: "As heavy as a big panda!",
    dashLogSaved: "sessions logged",
  ...
  es: {
    ...
    // Workout Log
    logTitle: "Registro",
    logHint: "Registro de entrenos, PR y totales por sesión. Se guarda solo.",
    logDateLabel: "Fecha",
    logTotalLifted: "Total levantado",
    logTotalReps: "Total de repeticiones",
    logExercisesLabel: "Ejercicios",
    logExerciseNameLabel: "Ejercicio",
    logRepsLabel: "Reps",
    logKgsLabel: "Kg",
    logAddExercise: "Añadir",
    logAddCustomExercise: "Nombre del ejercicio",
    logRemoveExercise: "Eliminar ejercicio",
    logAddSet: "Añadir serie",
    logRemoveSet: "Eliminar serie",
    logCustomPlaceholder: "Nombre del ejercicio",
    logFeelingsLabel: "¿Cómo se sintió?",
    logFeelingsPlaceholder: "Notas sobre esfuerzo, ánimo, recuperación…",
    logSave: "Guardar",
    logSaving: "Guardando…",
    logSaved: "Guardado",
    logNoSessions: "Aún no hay sesiones de entrenamiento. ¡Registra tu primera!",
    logNewSession: "Nueva sesión",
    logNewPr: "NUEVO PR",
    logExercisesTiny: "ej",
    logEmptyFlourish: "Aquí no hay nada todavía — tu primera sesión está a un toque.",
    logSelectHint: "Selecciona una sesión para revisarla o editarla",
    celebrationLight: "¡Hoy levantaste {total} kg!",
    celebrationModerate: "Buen trabajo — se movieron {total} kg. ¡Sigue así!",
    celebrationStrong: "¡Sesión intensa! Se aplastaron {total} kg.",
    celebrationBeast: "🔥 ¡{total} kg! ¡Eso es el desayuno de un T-Rex!",
    celebrationDefault: "Hoy moviste {total} kg.",
    celebrationRepCount: "¡Son {reps} repeticiones totales — gran resistencia!",
    celebrationElephant: "¡Eso es como levantar un elefante!",
    celebrationElephant2: "¡Un elefante adulto pesa aproximadamente eso!",
    celebrationTyrannosaurus: "Un T-Rex se retrocedería lentamente.",
    celebrationBlueWhale: "¡Más pesado que el corazón de una ballena azul!",
    celebrationSmallCar: "¡Más pesado que un coche pequeño!",
    celebrationGrandPiano: "¡Tan pesado como un piano de cola!",
    celebrationBabyElephant: "¡Tan pesado como un elefante bebé!",
    celebrationWashingMachine: "¡Aproximadamente el peso de una lavadora!",
    celebrationPanda: "¡Tan pesado como un gran panda!",
    dashLogSaved: "sesiones registradas",
