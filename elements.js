...
export const workoutList = document.getElementById("workout-list");
export const workoutEditor = document.querySelector(".workout-editor");
export const workoutLayout = document.querySelector(".workout-layout");
export const workoutExercisesContainer = document.getElementById("workout-exercises-container");
export const workoutDateInput = document.getElementById("workout-date-input");
export const workoutTonnageValue = document.getElementById("workout-tonnage-value");
export const workoutTotalRepsValue = document.getElementById("workout-total-reps-value");
export const workoutCelebration = document.getElementById("workout-celebration");
export const workoutCelebrationText = document.getElementById("workout-celebration-text");
export const workoutAddExerciseName = document.getElementById("workout-add-exercise-name");
export const workoutAddExerciseSubmit = document.getElementById("workout-add-exercise-submit");
export const workoutFeelingsInput = document.getElementById("workout-feelings-input");
export const workoutSaveButton = document.getElementById("workout-save-btn");
export const newWorkoutButton = document.getElementById("workout-new");
